...
import com.dipro.closet.ui.home.adapter.HomePagerAdapter;
import com.dipro.closet.ui.home.event.AddToDressRoomEvent;
    ...
    */
    ...
    private void openGallery() {
        Matisse.from(this)
                ...
                .capture(true)
                .captureStrategy(new CaptureStrategy(true, "com.dipro.closet.camera.fileprovider"))
                .countable(true)
                .maxSelectable(1)
